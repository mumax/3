...
const KERNMUL2D = `
	...
	//-----------------------------------------------------------
	// Compiling /tmp/tmpxft_00005934_00000000-9_kernmul2d.cpp3.i (/tmp/ccBI#.IFyMTm)
	//-----------------------------------------------------------
	...
	.file	1	"<command-line>"
	.file	2	"/tmp/tmpxft_00005934_00000000-8_kernmul2d.cudafe2.gpu"
...
$LDWend_kernmul2D:
	...
	@@DWARF .byte	0x9e, 0x04, 0x00, 0x00, 0x02, 0x00
	@@DWARF .4byte	.debug_abbrev
	@@DWARF .4byte	0x742f0108, 0x742f706d, 0x6678706d, 0x30305f74
	@@DWARF .4byte	0x39353030, 0x305f3433, 0x30303030, 0x2d303030
	...
	@@DWARF .4byte	0x7570672f, 0x7874702f, 0x65706f00, 0x2063636e
	@@DWARF .byte	0x34, 0x2e, 0x31, 0x00, 0x04, 0x00
	@@DWARF .4byte	.debug_line
	@@DWARF .4byte	0x736e7502, 0x656e6769, 0x6e692064, 0x04070074
	@@DWARF .4byte	0x75bb0b03, 0x33746e69, 0x00ba0c00, 0x0b040000
	@@DWARF .4byte	0x740078bc, 0x02000000, 0x04010023, 0x0079bc0b
	@@DWARF .4byte	0x00000074, 0x01042302, 0x7abc0b04, 0x00007400
	@@DWARF .4byte	0x08230200, 0x0b050001, 0x69750167, 0x0033746e
	@@DWARF .4byte	0x00000084, 0x0000ba06, 0x8a0b0700, 0x6d696401
	@@DWARF .4byte	0x060c0033, 0x08000001, 0x78018b0b, 0x00007400
	@@DWARF .4byte	0x00230200, 0x8b0b0801, 0x74007901, 0x02000000
	@@DWARF .4byte	0x08010423, 0x7a018b0b, 0x00007400, 0x08230200
	@@DWARF .4byte	0x0b050001, 0x69640193, 0xcd00336d, 0x06000000
	@@DWARF .4byte	0x00000106, 0x746e6902, 0x06040500, 0x00000118
	@@DWARF .4byte	0x6f6c6602, 0x04007461, 0x01240904, 0x05080000
	...
	@@DWARF .4byte	0x646f4d64, 0xdb040065, 0x0b000001, 0x75633f07
	...
	@@DWARF .4byte	0x02080500, 0x72616863, 0x06010600, 0x000001e7
	@@DWARF .4byte	0x0001ef09, 0x03050800, 0x6c66fd0b, 0x3274616f
	@@DWARF .4byte	0x02250800, 0x0b040000, 0x240078fd, 0x02000001
	@@DWARF .4byte	0x04010023, 0x0079fd0b, 0x00000124, 0x01042302
	@@DWARF .4byte	0x730b0500, 0x6f6c6601, 0x00327461, 0x000001fb
	@@DWARF .4byte	0x0000740c, 0x02410100, 0x050d0000, 0x14100e00
	@@DWARF .4byte	0x635f5f0d, 0x72616475, 0x32695f74, 0x5f69706f
	@@DWARF .4byte	0x02340066, 0x18090000, 0x08000001, 0x00740c05
	@@DWARF .4byte	0x6e010000, 0x0d000002, 0x240f0006, 0x06000001
	@@DWARF .4byte	0x00000124, 0x00013409, 0x02050800, 0x676e6f6c
	...
	@@DWARF .byte	0x00, 0x2d, 0x01, 0x00, 0x00, 0x09, 0x03
	@@DWARF .quad	__cudaparm_kernmul2D_fftMx
	@@DWARF .4byte	0x1d0e1107, 0x4d746666, 0x012d0079, 0x03090000
	@@DWARF .quad	__cudaparm_kernmul2D_fftMy
	@@DWARF .4byte	0x1d0e1107, 0x4d746666, 0x012d007a, 0x03090000
	@@DWARF .quad	__cudaparm_kernmul2D_fftMz
	@@DWARF .4byte	0x1d0e1107, 0x4b746666, 0x2d007878, 0x09000001
	@@DWARF .byte	0x03
	@@DWARF .quad	__cudaparm_kernmul2D_fftKxx
	@@DWARF .4byte	0x1d0e1107, 0x4b746666, 0x2d007979, 0x09000001
	@@DWARF .byte	0x03
	@@DWARF .quad	__cudaparm_kernmul2D_fftKyy
	@@DWARF .4byte	0x1d0e1107, 0x4b746666, 0x2d007a7a, 0x09000001
	@@DWARF .byte	0x03
	@@DWARF .quad	__cudaparm_kernmul2D_fftKzz
	@@DWARF .4byte	0x1d0e1107, 0x4b746666, 0x2d007a79, 0x09000001
	@@DWARF .byte	0x03
	@@DWARF .quad	__cudaparm_kernmul2D_fftKyz
	@@DWARF .byte	0x07, 0x11, 0x0e, 0x1d, 0x4e, 0x31, 0x00, 0x18
	@@DWARF .byte	0x01, 0x00, 0x00, 0x09, 0x03
	@@DWARF .quad	__cudaparm_kernmul2D_N1
	@@DWARF .byte	0x07, 0x11, 0x0e, 0x1d, 0x4e, 0x32, 0x00, 0x18
	@@DWARF .byte	0x01, 0x00, 0x00, 0x09, 0x03
	@@DWARF .quad	__cudaparm_kernmul2D_N2
	@@DWARF .byte	0x07, 0x12
	@@DWARF .quad	$LDWbeginblock_234_1
	@@DWARF .quad	$LDWendblock_234_1
	@@DWARF .4byte	0x6a1f0e13, 0x00011800, 0xb6900500, 0x020195e4
	@@DWARF .4byte	0x6b200e13, 0x00011800, 0xb2900600, 0x02abc8e2
	@@DWARF .4byte	0x260e1302, 0x01180049, 0x90060000, 0xabc8e4b8
	@@DWARF .4byte	0x0e130202, 0x78784b28, 0x00012400, 0xb2900500
	@@DWARF .4byte	0x020195cc, 0x4b290e13, 0x24007979, 0x05000001
	@@DWARF .4byte	0x95ccb490, 0x0e130201, 0x7a7a4b2a, 0x00012400
	@@DWARF .4byte	0xb6900500, 0x020195cc, 0x4b2b0e13, 0x24007a79
	@@DWARF .4byte	0x05000001, 0x95ccb890, 0x0e130201, 0x1800652e
	@@DWARF .4byte	0x06000001, 0xc8e6b190, 0x130202ab, 0x6572300e
	@@DWARF .4byte	0x2400784d, 0x06000001, 0x98e2b090, 0x130202ab
	@@DWARF .4byte	0x6d69310e, 0x2400784d, 0x06000001, 0x98e2b290
	@@DWARF .4byte	0x130202ab, 0x6572320e, 0x2400794d, 0x06000001
	@@DWARF .4byte	0x98e2b490, 0x130202ab, 0x6d69330e, 0x2400794d
	@@DWARF .4byte	0x06000001, 0x98e2b690, 0x130202ab, 0x6572340e
	@@DWARF .4byte	0x24007a4d, 0x06000001, 0x98e2b890, 0x130202ab
	@@DWARF .4byte	0x6d69350e, 0x24007a4d, 0x06000001, 0x98e4b090
	...
	@@DWARF .4byte	0x000004a2, 0x00000294, 0x6e72656b, 0x326c756d
