...
)
{
	...
	.reg .s64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducemaxabs$__cuda_local_var_35114_32_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd9, reducemaxabs$__cuda_local_var_35114_32_non_const_sdata;
	add.s64 	%rd3, %rd9, %rd8;
...
BB0_8:
	...
	.loc 1 8 1
	ld.shared.f32 	%f28, [reducemaxabs$__cuda_local_var_35114_32_non_const_sdata];
	.loc 2 3659 10
	abs.f32 	%f29, %f28;
	.loc 1 8 37
	mov.b32 	 %r13, %f29;
...
)
{
	...
	.reg .s64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducemaxabs$__cuda_local_var_35341_32_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd8, reducemaxabs$__cuda_local_var_35341_32_non_const_sdata;
	add.s64 	%rd2, %rd8, %rd7;
...
BB0_8:
	...
	ld.shared.f32 	%f28, [reducemaxabs$__cuda_local_var_35341_32_non_const_sdata];
	abs.f32 	%f29, %f28;
	mov.b32 	 %r13, %f29;
