...
//	c := new(SymmetricHtoD)
//	for i := 0; i < 3; i++ {
//		c.devin[i] = core.MakeChan1("convIn", input.Unit(), m) // TODO: blocks??
//		c.devout[i] = core.MakeChan1("convOut", input.Unit(), m)
//	}
...
//}
//
//func make3RChan(c [3]core.Chan1) [3]core.RChan1 {
//	return [3]core.RChan1{c[0].NewReader(), c[1].NewReader(), c[2].NewReader()}
//}
