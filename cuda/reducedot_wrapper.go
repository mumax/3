...
)
{
	...
	.reg .s64 	%rd<16>;
	// demoted variable
	.shared .align 4 .b8 reducedot$__cuda_local_var_34410_32_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd11, reducedot$__cuda_local_var_34410_32_non_const_sdata;
...
BB0_8:
	...
	ld.shared.f32 	%f28, [reducedot$__cuda_local_var_34410_32_non_const_sdata];
...
)
{
	...
	.reg .s64 	%rd<16>;
	// demoted variable
	.shared .align 4 .b8 reducedot$__cuda_local_var_34637_32_non_const_sdata[2048];
...
BB0_2:
	mul.wide.s32 	%rd10, %r2, 4;
	mov.u64 	%rd11, reducedot$__cuda_local_var_34637_32_non_const_sdata;
	add.s64 	%rd3, %rd11, %rd10;
	st.shared.f32 	[%rd3], %f30;
	bar.sync 	0;
	setp.lt.u32	%p3, %r14, 66;
...
BB0_8:
	...
	cvta.to.global.u64 	%rd15, %rd4;
	ld.shared.f32 	%f28, [reducedot$__cuda_local_var_34637_32_non_const_sdata];
	atom.global.add.f32 	%f29, [%rd15], %f28;
...
)
{
	...
	.reg .s64 	%rd<16>;
	// demoted variable
	.shared .align 4 .b8 reducedot$__cuda_local_var_34813_32_non_const_sdata[2048];
...
BB5_2:
	mul.wide.s32 	%rd10, %r2, 4;
	mov.u64 	%rd11, reducedot$__cuda_local_var_34813_32_non_const_sdata;
	add.s64 	%rd3, %rd11, %rd10;
	st.shared.f32 	[%rd3], %f30;
	bar.sync 	0;
	setp.lt.u32	%p3, %r14, 66;
...
BB5_8:
	...
	cvta.to.global.u64 	%rd15, %rd4;
	ld.shared.f32 	%f28, [reducedot$__cuda_local_var_34813_32_non_const_sdata];
	atom.global.add.f32 	%f29, [%rd15], %f28;
...
)
{
	...
	.reg .s64 	%rd<16>;
	// demoted variable
	.shared .align 4 .b8 reducedot$__cuda_local_var_42393_32_non_const_sdata[2048];
...
BB6_2:
	mul.wide.s32 	%rd10, %r2, 4;
	mov.u64 	%rd11, reducedot$__cuda_local_var_42393_32_non_const_sdata;
	add.s64 	%rd3, %rd11, %rd10;
	st.shared.f32 	[%rd3], %f30;
	bar.sync 	0;
	setp.lt.u32	%p3, %r14, 66;
...
BB6_8:
	...
	cvta.to.global.u64 	%rd15, %rd4;
	ld.shared.f32 	%f28, [reducedot$__cuda_local_var_42393_32_non_const_sdata];
	atom.global.add.f32 	%f29, [%rd15], %f28;
