...
BB0_13:
	...
	rem.s32 	%r232, %r106, %r53;
	bra.uni 	BB0_15;

BB0_14:
	add.s32 	%r107, %r53, -1;
	min.s32 	%r232, %r13, %r107;

BB0_15:
	mad.lo.s32 	%r117, %r65, %r53, %r232;
	cvt.s64.s32	%rd2, %r117;
	mul.wide.s32 	%rd36, %r117, 4;
	add.s64 	%rd37, %rd15, %rd36;
	add.s64 	%rd39, %rd14, %rd36;
	add.s64 	%rd41, %rd13, %rd36;
	ld.global.f32 	%f270, [%rd37];
	ld.global.f32 	%f271, [%rd39];
...
BB0_18:
	...
	shr.u32 	%r120, %r119, 1;
	add.s32 	%r233, %r17, %r120;

BB0_20:
	mul.wide.s32 	%rd45, %r233, 4;
	add.s64 	%rd46, %rd32, %rd45;
	ld.global.f32 	%f110, [%rd46];
...
BB0_22:
	...
	rem.s32 	%r234, %r129, %r54;
	bra.uni 	BB0_25;

BB0_24:
	mov.u32 	%r130, 0;
	max.s32 	%r234, %r21, %r130;

BB0_25:
	mad.lo.s32 	%r135, %r3, %r54, %r234;
	mad.lo.s32 	%r140, %r135, %r53, %r1;
	cvt.s64.s32	%rd3, %r140;
	mul.wide.s32 	%rd48, %r140, 4;
	add.s64 	%rd49, %rd15, %rd48;
	add.s64 	%rd51, %rd14, %rd48;
	add.s64 	%rd53, %rd13, %rd48;
	ld.global.f32 	%f273, [%rd49];
	ld.global.f32 	%f274, [%rd51];
	ld.global.f32 	%f275, [%rd53];
...
BB0_32:
	...
	rem.s32 	%r236, %r152, %r54;
	bra.uni 	BB0_35;

BB0_34:
	add.s32 	%r153, %r54, -1;
	min.s32 	%r236, %r29, %r153;

BB0_35:
	mad.lo.s32 	%r158, %r3, %r54, %r236;
	mad.lo.s32 	%r163, %r158, %r53, %r1;
	cvt.s64.s32	%rd4, %r163;
	mul.wide.s32 	%rd60, %r163, 4;
	add.s64 	%rd61, %rd15, %rd60;
	add.s64 	%rd63, %rd14, %rd60;
	add.s64 	%rd65, %rd13, %rd60;
	ld.global.f32 	%f276, [%rd61];
	ld.global.f32 	%f277, [%rd63];
	ld.global.f32 	%f278, [%rd65];
...
BB0_38:
	...
	shr.u32 	%r166, %r165, 1;
	add.s32 	%r237, %r33, %r166;

BB0_40:
	mul.wide.s32 	%rd69, %r237, 4;
	add.s64 	%rd70, %rd32, %rd69;
	ld.global.f32 	%f174, [%rd70];
...
BB0_42:
	...
	rem.s32 	%r238, %r175, %r55;
	bra.uni 	BB0_46;

BB0_45:
	mov.u32 	%r176, 0;
	max.s32 	%r238, %r37, %r176;

BB0_46:
	mad.lo.s32 	%r181, %r238, %r54, %r2;
	mad.lo.s32 	%r186, %r181, %r53, %r1;
	cvt.s64.s32	%rd5, %r186;
	mul.wide.s32 	%rd72, %r186, 4;
	add.s64 	%rd73, %rd15, %rd72;
	add.s64 	%rd75, %rd14, %rd72;
	add.s64 	%rd77, %rd13, %rd72;
	ld.global.f32 	%f279, [%rd73];
	ld.global.f32 	%f280, [%rd75];
	ld.global.f32 	%f281, [%rd77];
...
BB0_49:
	...
	shr.u32 	%r189, %r188, 1;
	add.s32 	%r239, %r41, %r189;

BB0_51:
	mul.wide.s32 	%rd81, %r239, 4;
...
BB0_53:
	...
	rem.s32 	%r240, %r198, %r55;
	bra.uni 	BB0_56;

BB0_55:
	add.s32 	%r199, %r55, -1;
	min.s32 	%r240, %r45, %r199;

BB0_56:
	mad.lo.s32 	%r204, %r240, %r54, %r2;
	mad.lo.s32 	%r209, %r204, %r53, %r1;
	cvt.s64.s32	%rd6, %r209;
	mul.wide.s32 	%rd84, %r209, 4;
	add.s64 	%rd85, %rd15, %rd84;
	add.s64 	%rd87, %rd14, %rd84;
	add.s64 	%rd89, %rd13, %rd84;
	ld.global.f32 	%f282, [%rd85];
	ld.global.f32 	%f283, [%rd87];
	ld.global.f32 	%f284, [%rd89];
...
BB0_59:
	...
	shr.u32 	%r212, %r211, 1;
	add.s32 	%r241, %r49, %r212;

BB0_61:
	mul.wide.s32 	%rd93, %r241, 4;
	add.s64 	%rd94, %rd32, %rd93;
	ld.global.f32 	%f238, [%rd94];
