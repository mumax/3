...
// see exchange.cu
//func AddAFMExchange(B, m *data.Slice, AFMex float32,AFMR1 float32,AFMR2 float32, regions *Bytes, mesh *data.Mesh) {
func AddAFMExchange(B, m *data.Slice, AFMex float32, AFMR1 ,AFMR2 int, regions *Bytes, mesh *data.Mesh) {
	c := mesh.CellSize()
