...
<h2> Note </h2> 
This web interface is under active development not yet finished. Currently it should be treated as a rudimentary viewer only. Full control of the simulation and parameters, as well as plotting graphs, is underway.
<hr/>
...
Live graphs will be implemented soon.
