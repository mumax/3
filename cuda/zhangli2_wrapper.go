...
)
{
	...
	ld.param.u64 	%rd7, [addzhanglitorque2_param_0];
	ld.param.u64 	%rd8, [addzhanglitorque2_param_1];
	ld.param.u64 	%rd9, [addzhanglitorque2_param_2];
	ld.param.u64 	%rd10, [addzhanglitorque2_param_3];
	ld.param.u64 	%rd11, [addzhanglitorque2_param_4];
	ld.param.u64 	%rd12, [addzhanglitorque2_param_5];
	ld.param.u64 	%rd13, [addzhanglitorque2_param_6];
	ld.param.f32 	%f133, [addzhanglitorque2_param_7];
	ld.param.u64 	%rd14, [addzhanglitorque2_param_8];
	ld.param.f32 	%f134, [addzhanglitorque2_param_9];
	ld.param.u64 	%rd15, [addzhanglitorque2_param_10];
	ld.param.f32 	%f135, [addzhanglitorque2_param_11];
	ld.param.u64 	%rd16, [addzhanglitorque2_param_12];
	ld.param.f32 	%f136, [addzhanglitorque2_param_13];
	ld.param.u64 	%rd17, [addzhanglitorque2_param_14];
	ld.param.f32 	%f130, [addzhanglitorque2_param_15];
	ld.param.u64 	%rd18, [addzhanglitorque2_param_16];
	ld.param.f32 	%f131, [addzhanglitorque2_param_17];
	ld.param.u64 	%rd19, [addzhanglitorque2_param_18];
...
)
{
	...
	mov.u32 	%r72, %tid.z;
	mad.lo.s32 	%r73, %r70, %r71, %r72;
	setp.ge.s32	%p1, %r65, %r59;
	setp.ge.s32	%p2, %r69, %r60;
	or.pred  	%p3, %p1, %p2;
	setp.ge.s32	%p4, %r73, %r61;
	or.pred  	%p5, %p3, %p4;
	@%p5 bra 	BB0_78;
