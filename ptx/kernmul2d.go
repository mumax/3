...
const KERNMUL2D = `
	...
	//-----------------------------------------------------------
	// Compiling /tmp/tmpxft_00006e87_00000000-9_kernmul2d.cpp3.i (/tmp/ccBI#.rWeafg)
	//-----------------------------------------------------------
	...
	.file	1	"<command-line>"
	.file	2	"/tmp/tmpxft_00006e87_00000000-8_kernmul2d.cudafe2.gpu"
...
$L_0_1538:
	...
	mov.s32 	%r31, %r30;
	.loc	14	42	0
	ld.param.u64 	%rd1, [__cudaparm_kernmul2D_fftMx];
	cvt.s64.s32 	%rd2, %r31;
	...
	mov.f32 	%f2, %f1;
	.loc	14	43	0
	ld.param.u64 	%rd5, [__cudaparm_kernmul2D_fftMx];
	cvt.s64.s32 	%rd6, %r31;
	...
	mov.f32 	%f4, %f3;
	.loc	14	45	0
	ld.param.u64 	%rd9, [__cudaparm_kernmul2D_fftMy];
	...
	mov.f32 	%f6, %f5;
	.loc	14	46	0
	ld.param.u64 	%rd13, [__cudaparm_kernmul2D_fftMy];
	cvt.s64.s32 	%rd14, %r31;
	...
	mov.f32 	%f10, %f9;
	.loc	14	49	0
	ld.param.u64 	%rd21, [__cudaparm_kernmul2D_fftMz];
	...
	mov.f32 	%f12, %f11;
	.loc	14	51	0
	ld.param.u64 	%rd25, [__cudaparm_kernmul2D_fftKxx];
	...
	mov.f32 	%f14, %f13;
	.loc	14	52	0
	ld.param.u64 	%rd29, [__cudaparm_kernmul2D_fftKyy];
	...
	mov.f32 	%f16, %f15;
	.loc	14	53	0
	ld.param.u64 	%rd33, [__cudaparm_kernmul2D_fftKzz];
	...
	mov.f32 	%f18, %f17;
	.loc	14	55	0
	ld.param.u64 	%rd37, [__cudaparm_kernmul2D_fftKyz];
...
$LDWend_kernmul2D:
	...
	@@DWARF .4byte	0x65363030, 0x305f3738, 0x30303030, 0x2d303030
	...
	@@DWARF .4byte	0x0e130202, 0x14006528, 0x06000001, 0xc8e6b190
	@@DWARF .4byte	0x130202ab, 0x65722a0e, 0x2000784d, 0x05000001
	@@DWARF .4byte	0x95ccb290, 0x0e130201, 0x4d6d692b, 0x01200078
	@@DWARF .4byte	0x90050000, 0x0195ccb4, 0x2d0e1302, 0x794d6572
	@@DWARF .4byte	0x00012000, 0xb6900500, 0x020195cc, 0x692e0e13
	@@DWARF .4byte	0x00794d6d, 0x00000120, 0xccb89005, 0x13020195
	@@DWARF .4byte	0x6572300e, 0x20007a4d, 0x06000001, 0x98e2b090
	@@DWARF .4byte	0x130202ab, 0x6d69310e, 0x20007a4d, 0x06000001
	@@DWARF .4byte	0x98e2b290, 0x130202ab, 0x784b330e, 0x01200078
	@@DWARF .4byte	0x90060000, 0xab98e2b4, 0x0e130202, 0x79794b34
	@@DWARF .4byte	0x00012000, 0xb6900600, 0x02ab98e2, 0x350e1302
	@@DWARF .4byte	0x007a7a4b, 0x00000120, 0xe2b89006, 0x0202ab98
	@@DWARF .4byte	0x4b370e13, 0x20007a79, 0x06000001, 0x98e4b090
