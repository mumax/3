...
)
{
	...
	.reg .b64 	%rd<16>;
	// demoted variable
	.shared .align 4 .b8 reducemaxdiff$__cuda_local_var_42874_32_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd11, reducemaxdiff$__cuda_local_var_42874_32_non_const_sdata;
...
BB0_8:
	...
	ld.shared.f32 	%f30, [reducemaxdiff$__cuda_local_var_42874_32_non_const_sdata];
	abs.f32 	%f31, %f30;
	mov.b32 	 %r13, %f31;
...
)
{
	...
	.reg .b64 	%rd<16>;
	// demoted variable
	.shared .align 4 .b8 reducemaxdiff$__cuda_local_var_43170_32_non_const_sdata[2048];
...
BB0_2:
	mul.wide.s32 	%rd10, %r2, 4;
	mov.u64 	%rd11, reducemaxdiff$__cuda_local_var_43170_32_non_const_sdata;
	add.s64 	%rd3, %rd11, %rd10;
	st.shared.f32 	[%rd3], %f32;
	bar.sync 	0;
	setp.lt.u32	%p3, %r16, 66;
...
BB0_8:
	...
	ld.shared.f32 	%f30, [reducemaxdiff$__cuda_local_var_43170_32_non_const_sdata];
	abs.f32 	%f31, %f30;
	mov.b32 	 %r13, %f31;
	cvta.to.global.u64 	%rd15, %rd4;
	atom.global.max.s32 	%r14, [%rd15], %r13;
...
)
{
	...
	.reg .b64 	%rd<16>;
	// demoted variable
	.shared .align 4 .b8 reducemaxdiff$__cuda_local_var_43427_32_non_const_sdata[2048];
...
BB6_2:
	mul.wide.s32 	%rd10, %r2, 4;
	mov.u64 	%rd11, reducemaxdiff$__cuda_local_var_43427_32_non_const_sdata;
	add.s64 	%rd3, %rd11, %rd10;
	st.shared.f32 	[%rd3], %f32;
	bar.sync 	0;
	setp.lt.u32	%p3, %r16, 66;
...
BB6_8:
	...
	ld.shared.f32 	%f30, [reducemaxdiff$__cuda_local_var_43427_32_non_const_sdata];
	abs.f32 	%f31, %f30;
	mov.b32 	 %r13, %f31;
	cvta.to.global.u64 	%rd15, %rd4;
	atom.global.max.s32 	%r14, [%rd15], %r13;
