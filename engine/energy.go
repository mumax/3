...
var (
	...
	Edens_total = NewScalarOutput("Edens_total", "J/m3", SetTotalEdens)
)
...
// vector dot product
func dot(a, b OutputQuantity) float64 {
	A, recyA := a.Slice()
	if recyA {
...
func makeEdensAdder(field OutputQuantity, prefactor float64) func(*data.Slice) {
