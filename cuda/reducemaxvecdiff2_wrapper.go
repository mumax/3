...
)
{
	...
	.reg .b64 	%rd<22>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecdiff2$__cuda_local_var_14008_35_non_const_sdata[2048];
...
BB0_2:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducemaxvecdiff2$__cuda_local_var_14008_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
...
BB0_8:
	...
	ld.shared.f32 	%f38, [reducemaxvecdiff2$__cuda_local_var_14008_35_non_const_sdata];
	abs.f32 	%f39, %f38;
	mov.b32 	 %r19, %f39;
...
)
{
	...
	.reg .b64 	%rd<22>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecdiff2$__cuda_local_var_14588_35_non_const_sdata[2048];
...
BB0_3:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducemaxvecdiff2$__cuda_local_var_14588_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
	st.shared.f32 	[%r7], %f41;
	bar.sync 	0;
	setp.lt.u32	%p3, %r22, 66;
...
BB0_9:
	...
	ld.shared.f32 	%f38, [reducemaxvecdiff2$__cuda_local_var_14588_35_non_const_sdata];
	abs.f32 	%f39, %f38;
	mov.b32 	 %r19, %f39;
	cvta.to.global.u64 	%rd21, %rd7;
	atom.global.max.s32 	%r20, [%rd21], %r19;
...
)
{
	...
	.reg .b64 	%rd<22>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecdiff2$__cuda_local_var_15486_35_non_const_sdata[2048];
...
BB0_3:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducemaxvecdiff2$__cuda_local_var_15486_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
	st.shared.f32 	[%r7], %f41;
	bar.sync 	0;
	setp.lt.u32	%p3, %r22, 66;
...
BB0_9:
	...
	ld.shared.f32 	%f38, [reducemaxvecdiff2$__cuda_local_var_15486_35_non_const_sdata];
	abs.f32 	%f39, %f38;
	mov.b32 	 %r19, %f39;
	cvta.to.global.u64 	%rd21, %rd7;
	atom.global.max.s32 	%r20, [%rd21], %r19;
...
)
{
	...
	.reg .b64 	%rd<22>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecdiff2$__cuda_local_var_15595_35_non_const_sdata[2048];
...
BB0_3:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducemaxvecdiff2$__cuda_local_var_15595_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
	st.shared.f32 	[%r7], %f41;
	bar.sync 	0;
	setp.lt.u32	%p3, %r22, 66;
...
BB0_9:
	...
	ld.shared.f32 	%f38, [reducemaxvecdiff2$__cuda_local_var_15595_35_non_const_sdata];
	abs.f32 	%f39, %f38;
	mov.b32 	 %r19, %f39;
	cvta.to.global.u64 	%rd21, %rd7;
	atom.global.max.s32 	%r20, [%rd21], %r19;
...
)
{
	...
	.reg .b64 	%rd<22>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecdiff2$__cuda_local_var_15694_35_non_const_sdata[2048];
...
BB0_3:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducemaxvecdiff2$__cuda_local_var_15694_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
	st.shared.f32 	[%r7], %f41;
	bar.sync 	0;
	setp.lt.u32	%p3, %r22, 66;
...
BB0_9:
	...
	ld.shared.f32 	%f38, [reducemaxvecdiff2$__cuda_local_var_15694_35_non_const_sdata];
	abs.f32 	%f39, %f38;
	mov.b32 	 %r19, %f39;
	cvta.to.global.u64 	%rd21, %rd7;
	atom.global.max.s32 	%r20, [%rd21], %r19;
