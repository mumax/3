...
)
{
	...
	.reg .s64 	%rd<16>;
	// demoted variable
	.shared .align 4 .b8 reducedot$__cuda_local_var_33879_32_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd12, reducedot$__cuda_local_var_33879_32_non_const_sdata;
...
BB0_8:
	...
	.loc 1 9 1
	ld.shared.f32 	%f28, [reducedot$__cuda_local_var_33879_32_non_const_sdata];
	.loc 2 3725 3
...
)
{
	...
	.reg .s64 	%rd<16>;
	// demoted variable
	.shared .align 4 .b8 reducedot$__cuda_local_var_33952_32_non_const_sdata[2048];
...
BB0_2:
	.loc 1 9 1
	mul.wide.s32 	%rd11, %r2, 4;
	mov.u64 	%rd12, reducedot$__cuda_local_var_33952_32_non_const_sdata;
	add.s64 	%rd4, %rd12, %rd11;
	st.shared.f32 	[%rd4], %f30;
	bar.sync 	0;
	.loc 1 9 1
...
BB0_8:
	...
	.loc 1 9 1
	ld.shared.f32 	%f28, [reducedot$__cuda_local_var_33952_32_non_const_sdata];
	.loc 2 3725 3
	atom.global.add.f32 	%f29, [%rd1], %f28;
...
)
{
	...
	.reg .s64 	%rd<16>;
	// demoted variable
	.shared .align 4 .b8 reducedot$__cuda_local_var_34115_32_non_const_sdata[2048];
...
BB2_2:
	.loc 1 9 1
	mul.wide.s32 	%rd11, %r2, 4;
	mov.u64 	%rd12, reducedot$__cuda_local_var_34115_32_non_const_sdata;
	add.s64 	%rd4, %rd12, %rd11;
	st.shared.f32 	[%rd4], %f30;
	bar.sync 	0;
	.loc 1 9 1
...
BB2_8:
	...
	.loc 1 9 1
	ld.shared.f32 	%f28, [reducedot$__cuda_local_var_34115_32_non_const_sdata];
	.loc 3 3725 3
	atom.global.add.f32 	%f29, [%rd1], %f28;
