...
)
{
	...
	.reg .s64 	%rd<19>;
	// demoted variable
	.shared .align 4 .b8 __cuda_local_var_33803_35_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd15, __cuda_local_var_33803_35_non_const_sdata;
...
BB0_8:
	...
	.loc 2 10 1
	ld.shared.f32 	%f32, [__cuda_local_var_33803_35_non_const_sdata];
	.loc 3 395 5
	abs.f32 	%f33, %f32;
	.loc 2 10 1
	mov.b32 	 %r38, %f33;
...
BB0_2:
	.loc 2 10 1
	mul.wide.s32 	%rd14, %r2, 4;
	mov.u64 	%rd15, __cuda_local_var_33876_35_non_const_sdata;
	add.s64 	%rd5, %rd15, %rd14;
	st.shared.f32 	[%rd5], %f34;
	bar.sync 	0;
	.loc 2 10 1
...
BB0_8:
	...
	.loc 2 10 1
	ld.shared.f32 	%f32, [__cuda_local_var_33876_35_non_const_sdata];
	.loc 3 395 5
	abs.f32 	%f33, %f32;
	.loc 2 10 1
	mov.b32 	 %r38, %f33;
...
)
{
	...
	.reg .s64 	%rd<19>;
	// demoted variable
	.shared .align 4 .b8 __cuda_local_var_34025_35_non_const_sdata[2048];
...
BB2_2:
	.loc 3 10 1
	mul.wide.s32 	%rd14, %r2, 4;
	mov.u64 	%rd15, __cuda_local_var_34025_35_non_const_sdata;
	add.s64 	%rd5, %rd15, %rd14;
	st.shared.f32 	[%rd5], %f34;
	bar.sync 	0;
	.loc 3 10 1
...
BB2_8:
	...
	.loc 3 10 1
	ld.shared.f32 	%f32, [__cuda_local_var_34025_35_non_const_sdata];
	.loc 4 395 5
	abs.f32 	%f33, %f32;
	.loc 3 10 1
	mov.b32 	 %r38, %f33;
