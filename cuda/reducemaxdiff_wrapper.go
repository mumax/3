...
)
{
	...
	.reg .s64 	%rd<16>;
	// demoted variable
	.shared .align 4 .b8 reducemaxdiff$__cuda_local_var_34396_32_non_const_sdata[2048];
...
BB2_2:
	mul.wide.s32 	%rd10, %r2, 4;
	mov.u64 	%rd11, reducemaxdiff$__cuda_local_var_34396_32_non_const_sdata;
	add.s64 	%rd3, %rd11, %rd10;
	st.shared.f32 	[%rd3], %f32;
	bar.sync 	0;
	setp.lt.u32	%p3, %r16, 66;
...
BB2_8:
	...
	cvta.to.global.u64 	%rd15, %rd4;
	ld.shared.f32 	%f30, [reducemaxdiff$__cuda_local_var_34396_32_non_const_sdata];
	abs.f32 	%f31, %f30;
	mov.b32 	 %r13, %f31;
	atom.global.max.s32 	%r14, [%rd15], %r13;
