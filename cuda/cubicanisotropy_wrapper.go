...
BB0_7:
	...
	mul.f32 	%f49, %f45, %f45;
	mul.f32 	%f50, %f48, %f48;
	fma.rn.f32 	%f51, %f48, %f48, %f49;
	mul.f32 	%f52, %f42, %f8;
	mul.f32 	%f53, %f42, %f9;
	mul.f32 	%f54, %f42, %f10;
	fma.rn.f32 	%f55, %f42, %f42, %f50;
	mul.f32 	%f56, %f45, %f30;
	mul.f32 	%f57, %f45, %f27;
	mul.f32 	%f58, %f45, %f25;
	mul.f32 	%f59, %f55, %f56;
	mul.f32 	%f60, %f55, %f57;
	mul.f32 	%f61, %f55, %f58;
	fma.rn.f32 	%f62, %f51, %f52, %f59;
	fma.rn.f32 	%f63, %f51, %f53, %f60;
	fma.rn.f32 	%f64, %f51, %f54, %f61;
	fma.rn.f32 	%f65, %f42, %f42, %f49;
	mul.f32 	%f66, %f48, %f29;
	mul.f32 	%f67, %f48, %f33;
	mul.f32 	%f68, %f48, %f36;
	fma.rn.f32 	%f69, %f65, %f66, %f62;
	fma.rn.f32 	%f70, %f65, %f67, %f63;
	fma.rn.f32 	%f71, %f65, %f68, %f64;
