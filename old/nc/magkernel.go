...
func magKernel(size [3]int, cellsize [3]float64, periodic [3]int, accuracy int) [3][3]Block {
	...
	//						kern[s][d].Array[xw][yw][zw] += float32(B[d]) // Add: may have multiple contributions in case of periodicity
	//					}
	//				}
	//			}
	//		}
