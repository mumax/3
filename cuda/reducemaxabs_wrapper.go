...
BB0_2:
	...
	mov.u64 	%rd9, __cuda_local_var_33731_35_non_const_sdata;
	add.s64 	%rd3, %rd9, %rd8;
...
BB0_8:
	...
	.loc 2 8 1
	ld.shared.f32 	%f28, [__cuda_local_var_33731_35_non_const_sdata];
	.loc 3 395 5
	abs.f32 	%f29, %f28;
	.loc 2 8 1
	mov.b32 	 %r36, %f29;
...
BB0_2:
	.loc 2 8 1
	mul.wide.s32 	%rd8, %r2, 4;
	mov.u64 	%rd9, __cuda_local_var_33804_35_non_const_sdata;
	add.s64 	%rd3, %rd9, %rd8;
	st.shared.f32 	[%rd3], %f30;
	bar.sync 	0;
	.loc 2 8 1
...
BB0_8:
	...
	.loc 2 8 1
	ld.shared.f32 	%f28, [__cuda_local_var_33804_35_non_const_sdata];
	.loc 3 395 5
	abs.f32 	%f29, %f28;
	.loc 2 8 1
	mov.b32 	 %r36, %f29;
...
BB2_2:
	.loc 3 8 1
	mul.wide.s32 	%rd8, %r2, 4;
	mov.u64 	%rd9, __cuda_local_var_33953_35_non_const_sdata;
	add.s64 	%rd3, %rd9, %rd8;
	st.shared.f32 	[%rd3], %f30;
	bar.sync 	0;
	.loc 3 8 1
...
BB2_8:
	...
	.loc 3 8 1
	ld.shared.f32 	%f28, [__cuda_local_var_33953_35_non_const_sdata];
	.loc 4 395 5
	abs.f32 	%f29, %f28;
	.loc 3 8 1
	mov.b32 	 %r36, %f29;
