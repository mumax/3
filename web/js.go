...
<div id=div_1>
<table>
	<tr><script> rpcCall("setGridSize", [{{index .Mesh.Size 2}}, {{index .Mesh.Size 1}}, {{index .Mesh.Size 0}}], "err_1");        </script> <td>(cells)</td> </tr>
	<tr><script> rpcCall("setCellSize", [{{index .Mesh.CellSize 2}}, {{index .Mesh.CellSize 1}}, {{index .Mesh.CellSize 0}}], "err_1");  </script> <td>(m)    </td> </tr>
