...
BB0_4:
	...
	mul.f32 	%f25, %f21, %f21;
	ld.global.f32 	%f26, [%rd50];
	mul.f32 	%f27, %f26, %f25;
	add.f32 	%f28, %f25, 0f3F800000;
	add.f32 	%f29, %f25, 0fBF800000;
	mul.f32 	%f30, %f12, %f2;
	fma.rn.f32 	%f31, %f11, %f1, %f30;
	fma.rn.f32 	%f32, %f13, %f3, %f31;
	fma.rn.f32 	%f33, %f29, %f32, %f28;
