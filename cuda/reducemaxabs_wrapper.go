...
)
{
	...
	.reg .b64 	%rd<7>;
	// demoted variable
	.shared .align 4 .b8 reducemaxabs$__cuda_local_var_13919_35_non_const_sdata[2048];
...
BB0_2:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducemaxabs$__cuda_local_var_13919_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
...
BB0_8:
	...
	ld.shared.f32 	%f28, [reducemaxabs$__cuda_local_var_13919_35_non_const_sdata];
	abs.f32 	%f29, %f28;
	mov.b32 	 %r19, %f29;
...
)
{
	...
	.reg .b64 	%rd<7>;
	// demoted variable
	.shared .align 4 .b8 reducemaxabs$__cuda_local_var_14499_35_non_const_sdata[2048];
...
BB0_2:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducemaxabs$__cuda_local_var_14499_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
	st.shared.f32 	[%r7], %f31;
	bar.sync 	0;
	setp.lt.u32	%p3, %r22, 66;
...
BB0_8:
	...
	ld.shared.f32 	%f28, [reducemaxabs$__cuda_local_var_14499_35_non_const_sdata];
	abs.f32 	%f29, %f28;
	mov.b32 	 %r19, %f29;
	cvta.to.global.u64 	%rd6, %rd2;
	atom.global.max.s32 	%r20, [%rd6], %r19;
...
)
{
	...
	.reg .b64 	%rd<7>;
	// demoted variable
	.shared .align 4 .b8 reducemaxabs$__cuda_local_var_15397_35_non_const_sdata[2048];
...
BB0_2:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducemaxabs$__cuda_local_var_15397_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
	st.shared.f32 	[%r7], %f31;
	bar.sync 	0;
	setp.lt.u32	%p3, %r22, 66;
...
BB0_8:
	...
	ld.shared.f32 	%f28, [reducemaxabs$__cuda_local_var_15397_35_non_const_sdata];
	abs.f32 	%f29, %f28;
	mov.b32 	 %r19, %f29;
	cvta.to.global.u64 	%rd6, %rd2;
	atom.global.max.s32 	%r20, [%rd6], %r19;
...
)
{
	...
	.reg .b64 	%rd<7>;
	// demoted variable
	.shared .align 4 .b8 reducemaxabs$__cuda_local_var_15506_35_non_const_sdata[2048];
...
BB0_2:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducemaxabs$__cuda_local_var_15506_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
	st.shared.f32 	[%r7], %f31;
	bar.sync 	0;
	setp.lt.u32	%p3, %r22, 66;
...
BB0_8:
	...
	ld.shared.f32 	%f28, [reducemaxabs$__cuda_local_var_15506_35_non_const_sdata];
	abs.f32 	%f29, %f28;
	mov.b32 	 %r19, %f29;
	cvta.to.global.u64 	%rd6, %rd2;
	atom.global.max.s32 	%r20, [%rd6], %r19;
...
)
{
	...
	.reg .b64 	%rd<7>;
	// demoted variable
	.shared .align 4 .b8 reducemaxabs$__cuda_local_var_15605_35_non_const_sdata[2048];
...
BB0_2:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducemaxabs$__cuda_local_var_15605_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
	st.shared.f32 	[%r7], %f31;
	bar.sync 	0;
	setp.lt.u32	%p3, %r22, 66;
...
BB0_8:
	...
	ld.shared.f32 	%f28, [reducemaxabs$__cuda_local_var_15605_35_non_const_sdata];
	abs.f32 	%f29, %f28;
	mov.b32 	 %r19, %f29;
	cvta.to.global.u64 	%rd6, %rd2;
	atom.global.max.s32 	%r20, [%rd6], %r19;
