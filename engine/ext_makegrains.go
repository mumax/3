...
func init() {
	DeclFunc("ext_DefVoronoiRegions", DefVoronoi, "Voronoi tesselation (grain size, num regions)")
}

func DefVoronoi(grainsize float64, numRegions int) {
	dens := 1 / (grainsize * grainsize) // grains / m2
