...
)
{
	...
	ld.param.f32 	%f69, [adduniaxialanisotropy2_param_7];
	...
	ld.param.f32 	%f65, [adduniaxialanisotropy2_param_13];
	ld.param.u64 	%rd11, [adduniaxialanisotropy2_param_14];
	ld.param.f32 	%f66, [adduniaxialanisotropy2_param_15];
	ld.param.u64 	%rd12, [adduniaxialanisotropy2_param_16];
	ld.param.f32 	%f67, [adduniaxialanisotropy2_param_17];
...
BB0_7:
	mul.f32 	%f33, %f66, %f66;
	fma.rn.f32 	%f34, %f65, %f65, %f33;
	fma.rn.f32 	%f35, %f67, %f67, %f34;
	sqrt.rn.f32 	%f7, %f35;
...
BB0_18:
	div.rn.f32 	%f42, %f71, %f69;
	mul.f32 	%f73, %f42, 0f40800000;
...
BB0_19:
	...
	mul.f32 	%f45, %f13, %f44;
	fma.rn.f32 	%f46, %f12, %f43, %f45;
	ld.global.f32 	%f47, [%rd40];
	fma.rn.f32 	%f48, %f14, %f47, %f46;
	mul.f32 	%f49, %f18, %f48;
	mul.f32 	%f50, %f48, %f48;
	mul.f32 	%f51, %f48, %f50;
	mul.f32 	%f52, %f73, %f51;
