...
)
{
	...
	.reg .s64 	%rd<19>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecnorm2$__cuda_local_var_34243_32_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd14, reducemaxvecnorm2$__cuda_local_var_34243_32_non_const_sdata;
...
BB0_8:
	...
	ld.shared.f32 	%f32, [reducemaxvecnorm2$__cuda_local_var_34243_32_non_const_sdata];
	abs.f32 	%f33, %f32;
	mov.b32 	 %r13, %f33;
...
)
{
	...
	.reg .s64 	%rd<19>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecnorm2$__cuda_local_var_34316_32_non_const_sdata[2048];
...
BB0_2:
	mul.wide.s32 	%rd13, %r2, 4;
	mov.u64 	%rd14, reducemaxvecnorm2$__cuda_local_var_34316_32_non_const_sdata;
	add.s64 	%rd4, %rd14, %rd13;
	st.shared.f32 	[%rd4], %f34;
	bar.sync 	0;
	setp.lt.u32	%p3, %r16, 66;
...
BB0_8:
	...
	cvta.to.global.u64 	%rd18, %rd5;
	ld.shared.f32 	%f32, [reducemaxvecnorm2$__cuda_local_var_34316_32_non_const_sdata];
	abs.f32 	%f33, %f32;
	mov.b32 	 %r13, %f33;
	atom.global.max.s32 	%r14, [%rd18], %r13;
...
)
{
	...
	.reg .s64 	%rd<19>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecnorm2$__cuda_local_var_34896_32_non_const_sdata[2048];
...
BB5_2:
	mul.wide.s32 	%rd13, %r2, 4;
	mov.u64 	%rd14, reducemaxvecnorm2$__cuda_local_var_34896_32_non_const_sdata;
	add.s64 	%rd4, %rd14, %rd13;
	st.shared.f32 	[%rd4], %f34;
	bar.sync 	0;
	setp.lt.u32	%p3, %r16, 66;
...
BB5_8:
	...
	cvta.to.global.u64 	%rd18, %rd5;
	ld.shared.f32 	%f32, [reducemaxvecnorm2$__cuda_local_var_34896_32_non_const_sdata];
	abs.f32 	%f33, %f32;
	mov.b32 	 %r13, %f33;
	atom.global.max.s32 	%r14, [%rd18], %r13;
...
)
{
	...
	.reg .s64 	%rd<19>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecnorm2$__cuda_local_var_42476_32_non_const_sdata[2048];
...
BB6_2:
	mul.wide.s32 	%rd13, %r2, 4;
	mov.u64 	%rd14, reducemaxvecnorm2$__cuda_local_var_42476_32_non_const_sdata;
	add.s64 	%rd4, %rd14, %rd13;
	st.shared.f32 	[%rd4], %f34;
	bar.sync 	0;
	setp.lt.u32	%p3, %r16, 66;
...
BB6_8:
	...
	ld.shared.f32 	%f32, [reducemaxvecnorm2$__cuda_local_var_42476_32_non_const_sdata];
	abs.f32 	%f33, %f32;
	mov.b32 	 %r13, %f33;
	cvta.to.global.u64 	%rd18, %rd5;
	atom.global.max.s32 	%r14, [%rd18], %r13;
