...
)
{
	...
	.reg .s64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducemaxabs$__cuda_local_var_34411_32_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd8, reducemaxabs$__cuda_local_var_34411_32_non_const_sdata;
	add.s64 	%rd2, %rd8, %rd7;
...
BB0_8:
	...
	ld.shared.f32 	%f28, [reducemaxabs$__cuda_local_var_34411_32_non_const_sdata];
	abs.f32 	%f29, %f28;
	mov.b32 	 %r13, %f29;
...
)
{
	...
	.reg .s64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducemaxabs$__cuda_local_var_34638_32_non_const_sdata[2048];
...
BB0_2:
	mul.wide.s32 	%rd7, %r2, 4;
	mov.u64 	%rd8, reducemaxabs$__cuda_local_var_34638_32_non_const_sdata;
	add.s64 	%rd2, %rd8, %rd7;
	st.shared.f32 	[%rd2], %f30;
	bar.sync 	0;
	setp.lt.u32	%p3, %r16, 66;
...
BB0_8:
	...
	cvta.to.global.u64 	%rd12, %rd3;
	ld.shared.f32 	%f28, [reducemaxabs$__cuda_local_var_34638_32_non_const_sdata];
	abs.f32 	%f29, %f28;
	mov.b32 	 %r13, %f29;
	atom.global.max.s32 	%r14, [%rd12], %r13;
...
)
{
	...
	.reg .s64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducemaxabs$__cuda_local_var_34814_32_non_const_sdata[2048];
...
BB5_2:
	mul.wide.s32 	%rd7, %r2, 4;
	mov.u64 	%rd8, reducemaxabs$__cuda_local_var_34814_32_non_const_sdata;
	add.s64 	%rd2, %rd8, %rd7;
	st.shared.f32 	[%rd2], %f30;
	bar.sync 	0;
	setp.lt.u32	%p3, %r16, 66;
...
BB5_8:
	...
	cvta.to.global.u64 	%rd12, %rd3;
	ld.shared.f32 	%f28, [reducemaxabs$__cuda_local_var_34814_32_non_const_sdata];
	abs.f32 	%f29, %f28;
	mov.b32 	 %r13, %f29;
	atom.global.max.s32 	%r14, [%rd12], %r13;
...
)
{
	...
	.reg .s64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducemaxabs$__cuda_local_var_42394_32_non_const_sdata[2048];
...
BB6_2:
	mul.wide.s32 	%rd7, %r2, 4;
	mov.u64 	%rd8, reducemaxabs$__cuda_local_var_42394_32_non_const_sdata;
	add.s64 	%rd2, %rd8, %rd7;
	st.shared.f32 	[%rd2], %f30;
	bar.sync 	0;
	setp.lt.u32	%p3, %r16, 66;
...
BB6_8:
	...
	ld.shared.f32 	%f28, [reducemaxabs$__cuda_local_var_42394_32_non_const_sdata];
	abs.f32 	%f29, %f28;
	mov.b32 	 %r13, %f29;
	cvta.to.global.u64 	%rd12, %rd3;
	atom.global.max.s32 	%r14, [%rd12], %r13;
