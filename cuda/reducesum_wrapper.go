...
)
{
	...
	.reg .s64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducesum$__cuda_local_var_34150_32_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd8, reducesum$__cuda_local_var_34150_32_non_const_sdata;
	add.s64 	%rd2, %rd8, %rd7;
...
BB0_8:
	...
	ld.shared.f32 	%f27, [reducesum$__cuda_local_var_34150_32_non_const_sdata];
...
)
{
	...
	.reg .s64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducesum$__cuda_local_var_34223_32_non_const_sdata[2048];
...
BB0_2:
	mul.wide.s32 	%rd7, %r2, 4;
	mov.u64 	%rd8, reducesum$__cuda_local_var_34223_32_non_const_sdata;
	add.s64 	%rd2, %rd8, %rd7;
	st.shared.f32 	[%rd2], %f29;
	bar.sync 	0;
	setp.lt.u32	%p3, %r14, 66;
...
BB0_8:
	...
	cvta.to.global.u64 	%rd12, %rd3;
	ld.shared.f32 	%f27, [reducesum$__cuda_local_var_34223_32_non_const_sdata];
	atom.global.add.f32 	%f28, [%rd12], %f27;
...
)
{
	...
	.reg .s64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducesum$__cuda_local_var_34388_32_non_const_sdata[2048];
...
BB2_2:
	mul.wide.s32 	%rd7, %r2, 4;
	mov.u64 	%rd8, reducesum$__cuda_local_var_34388_32_non_const_sdata;
	add.s64 	%rd2, %rd8, %rd7;
	st.shared.f32 	[%rd2], %f29;
	bar.sync 	0;
	setp.lt.u32	%p3, %r14, 66;
...
BB2_8:
	...
	cvta.to.global.u64 	%rd12, %rd3;
	ld.shared.f32 	%f27, [reducesum$__cuda_local_var_34388_32_non_const_sdata];
	atom.global.add.f32 	%f28, [%rd12], %f27;
