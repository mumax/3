...
)
{
	...
	.reg .b64 	%rd<28>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecdiff2$__cuda_local_var_16932_35_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd23, reducemaxvecdiff2$__cuda_local_var_16932_35_non_const_sdata;
...
BB0_8:
	...
	ld.shared.f32 	%f38, [reducemaxvecdiff2$__cuda_local_var_16932_35_non_const_sdata];
	abs.f32 	%f39, %f38;
	mov.b32 	 %r13, %f39;
...
)
{
	...
	.reg .b64 	%rd<28>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecdiff2$__cuda_local_var_17423_35_non_const_sdata[2048];
...
BB0_2:
	mul.wide.s32 	%rd22, %r2, 4;
	mov.u64 	%rd23, reducemaxvecdiff2$__cuda_local_var_17423_35_non_const_sdata;
	add.s64 	%rd7, %rd23, %rd22;
	st.shared.f32 	[%rd7], %f40;
	bar.sync 	0;
	setp.lt.u32	%p3, %r16, 66;
...
BB0_8:
	...
	ld.shared.f32 	%f38, [reducemaxvecdiff2$__cuda_local_var_17423_35_non_const_sdata];
	abs.f32 	%f39, %f38;
	mov.b32 	 %r13, %f39;
	cvta.to.global.u64 	%rd27, %rd8;
	atom.global.max.s32 	%r14, [%rd27], %r13;
