...
)
{
	...
	.reg .s64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducemaxabs$__cuda_local_var_33880_32_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd9, reducemaxabs$__cuda_local_var_33880_32_non_const_sdata;
	add.s64 	%rd3, %rd9, %rd8;
...
BB0_8:
	...
	.loc 1 8 1
	ld.shared.f32 	%f28, [reducemaxabs$__cuda_local_var_33880_32_non_const_sdata];
	.loc 2 2750 10
	abs.f32 	%f29, %f28;
	.loc 1 8 37
	mov.b32 	 %r13, %f29;
...
)
{
	...
	.reg .s64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducemaxabs$__cuda_local_var_33953_32_non_const_sdata[2048];
...
BB0_2:
	.loc 1 8 1
	mul.wide.s32 	%rd8, %r2, 4;
	mov.u64 	%rd9, reducemaxabs$__cuda_local_var_33953_32_non_const_sdata;
	add.s64 	%rd3, %rd9, %rd8;
	st.shared.f32 	[%rd3], %f30;
	bar.sync 	0;
	.loc 1 8 1
...
BB0_8:
	...
	.loc 1 8 1
	ld.shared.f32 	%f28, [reducemaxabs$__cuda_local_var_33953_32_non_const_sdata];
	.loc 2 2750 10
	abs.f32 	%f29, %f28;
	.loc 1 8 37
	mov.b32 	 %r13, %f29;
...
)
{
	...
	.reg .s64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducemaxabs$__cuda_local_var_34116_32_non_const_sdata[2048];
...
BB2_2:
	.loc 1 8 1
	mul.wide.s32 	%rd8, %r2, 4;
	mov.u64 	%rd9, reducemaxabs$__cuda_local_var_34116_32_non_const_sdata;
	add.s64 	%rd3, %rd9, %rd8;
	st.shared.f32 	[%rd3], %f30;
	bar.sync 	0;
	.loc 1 8 1
...
BB2_8:
	...
	.loc 1 8 1
	ld.shared.f32 	%f28, [reducemaxabs$__cuda_local_var_34116_32_non_const_sdata];
	.loc 3 2750 10
	abs.f32 	%f29, %f28;
	.loc 1 8 37
	mov.b32 	 %r13, %f29;
