...
)
{
	...
	ld.param.u32 	%r4, [adddmi_param_11];
	...
	min.s32 	%r42, %r41, %r23;
	.loc 2 28 1
	mad.lo.s32 	%r43, %r22, %r5, %r42;
	.loc 3 238 5
	max.s32 	%r44, %r3, %r20;
	.loc 3 210 5
	min.s32 	%r45, %r44, %r29;
	.loc 2 28 1
	mad.lo.s32 	%r46, %r43, %r6, %r45;
	...
	min.s32 	%r49, %r48, %r23;
	.loc 2 28 1
	mad.lo.s32 	%r50, %r22, %r5, %r49;
	mad.lo.s32 	%r51, %r50, %r6, %r45;
...
)
{
	...
	min.s32 	%r38, %r37, %r23;
	.loc 3 28 1
	mad.lo.s32 	%r39, %r22, %r5, %r38;
	.loc 4 238 5
	max.s32 	%r40, %r3, %r20;
	.loc 4 210 5
	min.s32 	%r41, %r40, %r29;
	.loc 3 28 1
	mad.lo.s32 	%r42, %r39, %r6, %r41;
	...
	min.s32 	%r45, %r44, %r23;
	.loc 3 28 1
	mad.lo.s32 	%r46, %r22, %r5, %r45;
	mad.lo.s32 	%r47, %r46, %r6, %r41;
