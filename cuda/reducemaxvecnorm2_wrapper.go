...
)
{
	...
	.reg .s64 	%rd<19>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecnorm2$__cuda_local_var_34291_35_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd14, reducemaxvecnorm2$__cuda_local_var_34291_35_non_const_sdata;
...
BB0_8:
	...
	ld.shared.f32 	%f32, [reducemaxvecnorm2$__cuda_local_var_34291_35_non_const_sdata];
	abs.f32 	%f33, %f32;
	mov.b32 	 %r13, %f33;
...
)
{
	...
	.reg .s64 	%rd<19>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecnorm2$__cuda_local_var_34871_35_non_const_sdata[2048];
...
BB5_2:
	mul.wide.s32 	%rd13, %r2, 4;
	mov.u64 	%rd14, reducemaxvecnorm2$__cuda_local_var_34871_35_non_const_sdata;
	add.s64 	%rd4, %rd14, %rd13;
	st.shared.f32 	[%rd4], %f34;
	bar.sync 	0;
	setp.lt.u32	%p3, %r16, 66;
...
BB5_8:
	...
	cvta.to.global.u64 	%rd18, %rd5;
	ld.shared.f32 	%f32, [reducemaxvecnorm2$__cuda_local_var_34871_35_non_const_sdata];
	abs.f32 	%f33, %f32;
	mov.b32 	 %r13, %f33;
	atom.global.max.s32 	%r14, [%rd18], %r13;
...
)
{
	...
	.reg .b64 	%rd<19>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecnorm2$__cuda_local_var_42733_35_non_const_sdata[2048];
...
BB6_2:
	mul.wide.s32 	%rd13, %r2, 4;
	mov.u64 	%rd14, reducemaxvecnorm2$__cuda_local_var_42733_35_non_const_sdata;
	add.s64 	%rd4, %rd14, %rd13;
	st.shared.f32 	[%rd4], %f34;
	bar.sync 	0;
	setp.lt.u32	%p3, %r16, 66;
...
BB6_8:
	...
	ld.shared.f32 	%f32, [reducemaxvecnorm2$__cuda_local_var_42733_35_non_const_sdata];
	abs.f32 	%f33, %f32;
	mov.b32 	 %r13, %f33;
	cvta.to.global.u64 	%rd18, %rd5;
	atom.global.max.s32 	%r14, [%rd18], %r13;
...
)
{
	...
	.reg .b64 	%rd<19>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecnorm2$__cuda_local_var_16945_35_non_const_sdata[2048];
...
BB0_2:
	mul.wide.s32 	%rd13, %r2, 4;
	mov.u64 	%rd14, reducemaxvecnorm2$__cuda_local_var_16945_35_non_const_sdata;
	add.s64 	%rd4, %rd14, %rd13;
	st.shared.f32 	[%rd4], %f34;
	bar.sync 	0;
	setp.lt.u32	%p3, %r16, 66;
...
BB0_8:
	...
	ld.shared.f32 	%f32, [reducemaxvecnorm2$__cuda_local_var_16945_35_non_const_sdata];
	abs.f32 	%f33, %f32;
	mov.b32 	 %r13, %f33;
	cvta.to.global.u64 	%rd18, %rd5;
	atom.global.max.s32 	%r14, [%rd18], %r13;
...
)
{
	...
	.reg .b64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecnorm2$__cuda_local_var_15677_35_non_const_sdata[2048];
...
BB0_2:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducemaxvecnorm2$__cuda_local_var_15677_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
...
BB0_8:
	...
	ld.shared.f32 	%f32, [reducemaxvecnorm2$__cuda_local_var_15677_35_non_const_sdata];
	abs.f32 	%f33, %f32;
	mov.b32 	 %r19, %f33;
