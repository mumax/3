...
If you want to compile nevertheless, 4 essential components will be required to build mumax³: an ***NVIDIA driver***, ***Go***, ***CUDA*** (&geq;10.1, &leq;12.9) and ***C***.
...
<details><summary><b><i>Install CUDA</i></b> (&geq;10.1, &leq;12.9)</summary>
