...
)
{
	...
	.reg .b64 	%rd<10>;
	// demoted variable
	.shared .align 4 .b8 reducedot$__cuda_local_var_13918_35_non_const_sdata[2048];
...
BB0_2:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducedot$__cuda_local_var_13918_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
...
BB0_8:
	...
	ld.shared.f32 	%f28, [reducedot$__cuda_local_var_13918_35_non_const_sdata];
...
)
{
	...
	.reg .b64 	%rd<10>;
	// demoted variable
	.shared .align 4 .b8 reducedot$__cuda_local_var_14498_35_non_const_sdata[2048];
...
BB0_2:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducedot$__cuda_local_var_14498_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
	st.shared.f32 	[%r7], %f31;
	bar.sync 	0;
	setp.lt.u32	%p3, %r20, 66;
...
BB0_8:
	...
	ld.shared.f32 	%f28, [reducedot$__cuda_local_var_14498_35_non_const_sdata];
	cvta.to.global.u64 	%rd9, %rd3;
	atom.global.add.f32 	%f29, [%rd9], %f28;
...
)
{
	...
	.reg .b64 	%rd<10>;
	// demoted variable
	.shared .align 4 .b8 reducedot$__cuda_local_var_15396_35_non_const_sdata[2048];
...
BB0_2:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducedot$__cuda_local_var_15396_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
	st.shared.f32 	[%r7], %f31;
	bar.sync 	0;
	setp.lt.u32	%p3, %r20, 66;
...
BB0_8:
	...
	ld.shared.f32 	%f28, [reducedot$__cuda_local_var_15396_35_non_const_sdata];
	cvta.to.global.u64 	%rd9, %rd3;
	atom.global.add.f32 	%f29, [%rd9], %f28;
...
)
{
	...
	.reg .b64 	%rd<10>;
	// demoted variable
	.shared .align 4 .b8 reducedot$__cuda_local_var_15505_35_non_const_sdata[2048];
...
BB0_2:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducedot$__cuda_local_var_15505_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
	st.shared.f32 	[%r7], %f31;
	bar.sync 	0;
	setp.lt.u32	%p3, %r20, 66;
...
BB0_8:
	...
	ld.shared.f32 	%f28, [reducedot$__cuda_local_var_15505_35_non_const_sdata];
	cvta.to.global.u64 	%rd9, %rd3;
	atom.global.add.f32 	%f29, [%rd9], %f28;
...
)
{
	...
	.reg .b64 	%rd<10>;
	// demoted variable
	.shared .align 4 .b8 reducedot$__cuda_local_var_15604_35_non_const_sdata[2048];
...
BB0_2:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducedot$__cuda_local_var_15604_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
	st.shared.f32 	[%r7], %f31;
	bar.sync 	0;
	setp.lt.u32	%p3, %r20, 66;
...
BB0_8:
	...
	ld.shared.f32 	%f28, [reducedot$__cuda_local_var_15604_35_non_const_sdata];
	cvta.to.global.u64 	%rd9, %rd3;
	atom.global.add.f32 	%f29, [%rd9], %f28;
