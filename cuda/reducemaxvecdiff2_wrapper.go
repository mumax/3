...
)
{
	...
	.reg .s64 	%rd<28>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecdiff2$__cuda_local_var_34295_35_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd23, reducemaxvecdiff2$__cuda_local_var_34295_35_non_const_sdata;
...
BB0_8:
	...
	ld.shared.f32 	%f38, [reducemaxvecdiff2$__cuda_local_var_34295_35_non_const_sdata];
	abs.f32 	%f39, %f38;
	mov.b32 	 %r13, %f39;
...
)
{
	...
	.reg .s64 	%rd<28>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecdiff2$__cuda_local_var_34875_35_non_const_sdata[2048];
...
BB5_2:
	mul.wide.s32 	%rd22, %r2, 4;
	mov.u64 	%rd23, reducemaxvecdiff2$__cuda_local_var_34875_35_non_const_sdata;
	add.s64 	%rd7, %rd23, %rd22;
	st.shared.f32 	[%rd7], %f40;
	bar.sync 	0;
	setp.lt.u32	%p3, %r16, 66;
...
BB5_8:
	...
	cvta.to.global.u64 	%rd27, %rd8;
	ld.shared.f32 	%f38, [reducemaxvecdiff2$__cuda_local_var_34875_35_non_const_sdata];
	abs.f32 	%f39, %f38;
	mov.b32 	 %r13, %f39;
	atom.global.max.s32 	%r14, [%rd27], %r13;
...
)
{
	...
	.reg .b64 	%rd<28>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecdiff2$__cuda_local_var_42737_35_non_const_sdata[2048];
...
BB6_2:
	mul.wide.s32 	%rd22, %r2, 4;
	mov.u64 	%rd23, reducemaxvecdiff2$__cuda_local_var_42737_35_non_const_sdata;
	add.s64 	%rd7, %rd23, %rd22;
	st.shared.f32 	[%rd7], %f40;
	bar.sync 	0;
	setp.lt.u32	%p3, %r16, 66;
...
BB6_8:
	...
	ld.shared.f32 	%f38, [reducemaxvecdiff2$__cuda_local_var_42737_35_non_const_sdata];
	abs.f32 	%f39, %f38;
	mov.b32 	 %r13, %f39;
	cvta.to.global.u64 	%rd27, %rd8;
	atom.global.max.s32 	%r14, [%rd27], %r13;
...
)
{
	...
	.reg .b64 	%rd<22>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecdiff2$__cuda_local_var_15681_35_non_const_sdata[2048];
...
BB0_3:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducemaxvecdiff2$__cuda_local_var_15681_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
...
BB0_9:
	...
	ld.shared.f32 	%f38, [reducemaxvecdiff2$__cuda_local_var_15681_35_non_const_sdata];
	abs.f32 	%f39, %f38;
	mov.b32 	 %r19, %f39;
