...
)
{
	...
	.reg .s64 	%rd<28>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecdiff2$__cuda_local_var_33837_32_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd24, reducemaxvecdiff2$__cuda_local_var_33837_32_non_const_sdata;
...
BB0_8:
	...
	.loc 1 14 1
	ld.shared.f32 	%f38, [reducemaxvecdiff2$__cuda_local_var_33837_32_non_const_sdata];
	.loc 2 2750 10
	abs.f32 	%f39, %f38;
	.loc 1 14 37
	mov.b32 	 %r13, %f39;
...
)
{
	...
	.reg .s64 	%rd<28>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecdiff2$__cuda_local_var_33910_32_non_const_sdata[2048];
...
BB0_2:
	.loc 1 14 1
	mul.wide.s32 	%rd23, %r2, 4;
	mov.u64 	%rd24, reducemaxvecdiff2$__cuda_local_var_33910_32_non_const_sdata;
	add.s64 	%rd8, %rd24, %rd23;
	st.shared.f32 	[%rd8], %f40;
	bar.sync 	0;
	.loc 1 14 1
...
BB0_8:
	...
	.loc 1 14 1
	ld.shared.f32 	%f38, [reducemaxvecdiff2$__cuda_local_var_33910_32_non_const_sdata];
	.loc 2 2750 10
	abs.f32 	%f39, %f38;
	.loc 1 14 37
	mov.b32 	 %r13, %f39;
...
)
{
	...
	.reg .s64 	%rd<28>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecdiff2$__cuda_local_var_34073_32_non_const_sdata[2048];
...
BB2_2:
	.loc 1 14 1
	mul.wide.s32 	%rd23, %r2, 4;
	mov.u64 	%rd24, reducemaxvecdiff2$__cuda_local_var_34073_32_non_const_sdata;
	add.s64 	%rd8, %rd24, %rd23;
	st.shared.f32 	[%rd8], %f40;
	bar.sync 	0;
	.loc 1 14 1
...
BB2_8:
	...
	.loc 1 14 1
	ld.shared.f32 	%f38, [reducemaxvecdiff2$__cuda_local_var_34073_32_non_const_sdata];
	.loc 3 2750 10
	abs.f32 	%f39, %f38;
	.loc 1 14 37
	mov.b32 	 %r13, %f39;
