...
func init() { Code["reducemaxvecdiff"] = REDUCEMAXVECDIFF }

const REDUCEMAXVECDIFF = `
//
...
.address_size 64
	...
	.file	1 "/tmp/tmpxft_00002417_00000000-9_reducemaxvecdiff.cpp3.i"
	.file	2 "/home/arne/src/code.google.com/p/nimble-cube/gpu/ptx/reducemaxvecdiff.cu"
...
.visible .entry reducevecdiff(
	.param .u64 reducevecdiff_param_0,
	.param .u64 reducevecdiff_param_1,
	.param .u64 reducevecdiff_param_2,
	.param .u64 reducevecdiff_param_3,
	.param .u64 reducevecdiff_param_4,
	.param .u64 reducevecdiff_param_5,
	.param .u64 reducevecdiff_param_6,
	.param .u32 reducevecdiff_param_7
)
{
	.reg .pred 	%p<8>;
	.reg .s32 	%r<45>;
	...
	ld.param.u64 	%rd9, [reducevecdiff_param_0];
	ld.param.u64 	%rd10, [reducevecdiff_param_1];
	ld.param.u64 	%rd11, [reducevecdiff_param_2];
	ld.param.u64 	%rd12, [reducevecdiff_param_3];
	ld.param.u64 	%rd13, [reducevecdiff_param_4];
	ld.param.u64 	%rd14, [reducevecdiff_param_5];
	ld.param.u64 	%rd15, [reducevecdiff_param_6];
	ld.param.u32 	%r9, [reducevecdiff_param_7];
...
BB0_2:
	...
	mov.u64 	%rd24, __cuda_local_var_35271_32_non_const_sdata;
...
BB0_8:
	...
	.loc 2 14 1
	ld.shared.u32 	%r41, [__cuda_local_var_35271_32_non_const_sdata];
	.loc 3 1881 5
