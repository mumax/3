...
)
{
	...
	.reg .s64 	%rd<16>;
	// demoted variable
	.shared .align 4 .b8 __cuda_local_var_33773_32_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd12, __cuda_local_var_33773_32_non_const_sdata;
...
BB0_8:
	...
	.loc 2 9 1
	ld.shared.f32 	%f28, [__cuda_local_var_33773_32_non_const_sdata];
	.loc 3 1844 5
...
)
{
	...
	.reg .s64 	%rd<16>;
	// demoted variable
	.shared .align 4 .b8 __cuda_local_var_33995_32_non_const_sdata[2048];
...
BB2_2:
	.loc 3 9 1
	mul.wide.s32 	%rd11, %r2, 4;
	mov.u64 	%rd12, __cuda_local_var_33995_32_non_const_sdata;
	add.s64 	%rd4, %rd12, %rd11;
	st.shared.f32 	[%rd4], %f30;
	bar.sync 	0;
	.loc 3 9 1
...
BB2_8:
	...
	.loc 3 9 1
	ld.shared.f32 	%f28, [__cuda_local_var_33995_32_non_const_sdata];
	.loc 4 1844 5
	atom.global.add.f32 	%f29, [%rd1], %f28;
