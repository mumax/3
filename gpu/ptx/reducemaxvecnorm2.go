...
.address_size 64
	...
	.file	1 "/tmp/tmpxft_000018da_00000000-9_reducemaxvecnorm2.cpp3.i"
	.file	2 "/home/arne/src/code.google.com/p/mx3/gpu/ptx/reducemaxvecnorm2.cu"
	.file	3 "/usr/local/cuda-5.0/nvvm/ci_include.h"
	.file	4 "/usr/local/cuda/bin/../include/sm_11_atomic_functions.h"
// __cuda_local_var_33924_32_non_const_sdata has been demoted
...
)
{
	...
	.reg .s64 	%rd<19>;
	// demoted variable
	.shared .align 4 .b8 __cuda_local_var_33924_32_non_const_sdata[2048];
...
BB0_2:
	...
	mov.u64 	%rd15, __cuda_local_var_33924_32_non_const_sdata;
...
BB0_8:
	...
	.loc 2 10 1
	ld.shared.u32 	%r38, [__cuda_local_var_33924_32_non_const_sdata];
	.loc 3 1881 5
