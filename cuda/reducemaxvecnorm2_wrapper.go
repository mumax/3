...
)
{
	...
	.reg .b64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecnorm2$__cuda_local_var_14004_35_non_const_sdata[2048];
...
BB0_2:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducemaxvecnorm2$__cuda_local_var_14004_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
...
BB0_8:
	...
	ld.shared.f32 	%f32, [reducemaxvecnorm2$__cuda_local_var_14004_35_non_const_sdata];
	abs.f32 	%f33, %f32;
	mov.b32 	 %r19, %f33;
...
)
{
	...
	.reg .b64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecnorm2$__cuda_local_var_14584_35_non_const_sdata[2048];
...
BB0_2:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducemaxvecnorm2$__cuda_local_var_14584_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
	st.shared.f32 	[%r7], %f35;
	bar.sync 	0;
	setp.lt.u32	%p3, %r22, 66;
...
BB0_8:
	...
	ld.shared.f32 	%f32, [reducemaxvecnorm2$__cuda_local_var_14584_35_non_const_sdata];
	abs.f32 	%f33, %f32;
	mov.b32 	 %r19, %f33;
	cvta.to.global.u64 	%rd12, %rd4;
	atom.global.max.s32 	%r20, [%rd12], %r19;
...
)
{
	...
	.reg .b64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecnorm2$__cuda_local_var_15482_35_non_const_sdata[2048];
...
BB0_2:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducemaxvecnorm2$__cuda_local_var_15482_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
	st.shared.f32 	[%r7], %f35;
	bar.sync 	0;
	setp.lt.u32	%p3, %r22, 66;
...
BB0_8:
	...
	ld.shared.f32 	%f32, [reducemaxvecnorm2$__cuda_local_var_15482_35_non_const_sdata];
	abs.f32 	%f33, %f32;
	mov.b32 	 %r19, %f33;
	cvta.to.global.u64 	%rd12, %rd4;
	atom.global.max.s32 	%r20, [%rd12], %r19;
...
)
{
	...
	.reg .b64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecnorm2$__cuda_local_var_15591_35_non_const_sdata[2048];
...
BB0_2:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducemaxvecnorm2$__cuda_local_var_15591_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
	st.shared.f32 	[%r7], %f35;
	bar.sync 	0;
	setp.lt.u32	%p3, %r22, 66;
...
BB0_8:
	...
	ld.shared.f32 	%f32, [reducemaxvecnorm2$__cuda_local_var_15591_35_non_const_sdata];
	abs.f32 	%f33, %f32;
	mov.b32 	 %r19, %f33;
	cvta.to.global.u64 	%rd12, %rd4;
	atom.global.max.s32 	%r20, [%rd12], %r19;
...
)
{
	...
	.reg .b64 	%rd<13>;
	// demoted variable
	.shared .align 4 .b8 reducemaxvecnorm2$__cuda_local_var_15690_35_non_const_sdata[2048];
...
BB0_2:
	shl.b32 	%r13, %r2, 2;
	mov.u32 	%r14, reducemaxvecnorm2$__cuda_local_var_15690_35_non_const_sdata;
	add.s32 	%r7, %r14, %r13;
	st.shared.f32 	[%r7], %f35;
	bar.sync 	0;
	setp.lt.u32	%p3, %r22, 66;
...
BB0_8:
	...
	ld.shared.f32 	%f32, [reducemaxvecnorm2$__cuda_local_var_15690_35_non_const_sdata];
	abs.f32 	%f33, %f32;
	mov.b32 	 %r19, %f33;
	cvta.to.global.u64 	%rd12, %rd4;
	atom.global.max.s32 	%r20, [%rd12], %r19;
